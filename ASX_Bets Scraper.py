...
def submission_id_list(start_date: dt.date, end_date = dt.date.today()) -> list:
    ...
    daily discussion and weekend discussion from the reddit automoderator who posts them on ASX_bets after this date. First creates a
    generator object which we then convert into a list. Elements of the list 
    can then be fed into comment_scrape as needed. Can take optional argument 
    of end date to find submissions between certain dates, otherwise this
